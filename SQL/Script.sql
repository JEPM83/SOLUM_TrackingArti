...
insert into "@EX_MODELO" (Code,Name,SQL,Columnas,State) values ('M3_TRACKING','Modelo consulta de tracking para cliente ARTI','BZ_CONEP_TRACKING_ARTI @A_CLIENTE @A_FECINI @A_FECFIN @A_PEDIDO',22,0)
...
insert SAP_TRACKING (Sociedad,U_EX_CLIENTE,Interno,Pedido,FecPed,FecApruCred,FecApruDscto,FecApruExhib,Fact_BV,FecFact_BV,Actualizaciones,Fecha_creacion)
select t0.Sociedad,'C'+ t0.U_EX_CLIENTE,t0.Interno,t0.Pedido,t0.FecPed,t0.FecApruCred,t0.FecApruDscto,t0.FecApruExhib,t0.Fact_BV,t0.FecFact_BV,0,GETDATE() from SAP_HOST_TRACKING t0
...
T4.Interno,T4.Pedido,T4.FecApruCred,T4.FecApruDscto,T4.FecApruExhib,

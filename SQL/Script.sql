...
as
select 'PEDDIF PICKING','N°PEDIDO ORIGINAL','PEDIDO ORIGINAL','APROB. CREDITO','APROB. DESCUENTO','APROB. EXHIBIDOR','PEDIDO','CLIENTE','FECHA CREACION','RECIBIDO','PREPARADO','DESPACHADO','ENTREGADO','LIQUIDADO','UBIGEO','TRANSP','PLACA','BULTOS','PESO','GUIA','GUIA REMISION','GUIA REMISION SUNAT','N° FACTURA','FACTURA BOLETA','OBS.'
...
R.Address2 AS 'UBIGEO',N.U_BZ_TRANSPORTISTA 'TRANSP',N.U_BZ_PLACA 'PLACA',N.U_BZ_BULTOS 'BULTOS',N.U_BZ_PESO_KG 'PESO',N.U_SYP_MDSD + '-' + N.U_SYP_MDCD 'GUIA',convert(varchar(16),N.Docdate + ' ' + dbo.GetTime(N.DocTime,0),120) 'GUIAREMISION',T5.bl_fechaRespuestaSUNAT,T4.Fact_BV,T4.FecFact_BV,R.U_BZ_EVENTUALIDADES 'OBS.'
...
SELECT '','A','A','A','A','A','A','A','A','A','A','A','A','A','A','A','A','N','N','A','A','A','A','A','A'
